...
while counter < 1000:
    ...
    while len(new_seats) >= 1:
        ...
        if column == 22 or column == 21 or column == 16 or column == 15 or column == 10 or column == 9 or column == 4 or column == 3:
            time_taken += 1
        elif column == 23 or column == 20 or column == 17 or column == 14 or column == 11 or column == 8 or column == 5 or column == 2:
            time_taken += 2
        else:
            time_taken += 3
    with open("plane_two_method2_results.txt", "a") as r:
        r.write("\n" + str(int(time_taken)))